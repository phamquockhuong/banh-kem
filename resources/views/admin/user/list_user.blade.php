...
<div class="container">
    ...
    <button style="margin-bottom: 10px" class="btn btn-primary delete_all" data-url="{{ url(' admin/user/delete_All') }}">Delete All Selected</button>
        ...
        @if($users->count())
            @foreach($users as $key => $user)
                <tr id="tr_{{$user->id}}">
                    ...
                    <td>{{ $user->email }}</td>
                    <td>
                         <a href="{{ url(' admin/user',$user->id) }}" class="btn btn-danger btn-sm"
                           data-tr="tr_{{$user->id}}"
